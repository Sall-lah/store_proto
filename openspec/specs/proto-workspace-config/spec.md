# Proto Workspace Configuration Specification

## Purpose
Defines the Buf workspace configuration, directory structure conventions, and code generation rules for the central `store_proto` repository.
...
- **THEN** it SHALL parse `buf.yaml` configured with `version: v2` and standard linting checks.
