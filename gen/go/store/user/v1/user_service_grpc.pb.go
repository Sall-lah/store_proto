...
const (
	UserService_CreateUserProfile_FullMethodName = "/store.user.v1.UserService/CreateUserProfile"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "store.user.v1.UserService",
	...
	Metadata: "store/user/v1/user_service.proto",
}
